    ...
    return (
        <div className="auth-card glass-strong animate-scale-in">
            <div className="auth-header">
                <UserPlus className="auth-icon gradient-text" size={40} />
                <h2 className="auth-title">Create Account</h2>
                <p className="auth-subtitle">Start building your professional resume today</p>
            </div>

            {apiError && (
                <div className="auth-error-message" style={{ color: '#ef4444', textAlign: 'center', marginBottom: '1rem', padding: '0.5rem', background: 'rgba(239, 68, 68, 0.1)', borderRadius: '0.5rem' }}>
                    {apiError}
                </div>
            )}
